...
def test_code(test_case):
    ...
    Rotation = rot_z(yaw) * rot_y(pitch) * rot_x(roll) * R_corr.T
    ...
    res_ee = T0_7.subs([(q1, theta1), (q2, theta2 ), (q3, theta3), (q4, theta4), (q5, theta5), (q6,theta6)]).evalf()[0:3, 3]
    ...
    your_ee = res_ee # <--- Load your calculated end effector value from your forward kinematics
