...
class RoverState():
    def __init__(self):
        ...
        #add more
        self.stopsteer_num = 0
        self.stopspeed_num = 0
        self.loopstep = 0
...
def telemetry(sid, data):
    ...
    #print("mode:%s, steer:%d, brake:%s, stopsppednum:%s, steernum:%s, sysclestep:%s,vel:%s"%(Rover.mode,Rover.steer,Rover.brake,Rover.stopspeed_num,Rover.stopsteer_num,Rover.loopstep,Rover.vel))
    if data:
        global Rover
